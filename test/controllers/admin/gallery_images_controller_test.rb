...
class Admin::GalleryImagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_gallery_image" do
    assert_difference('Admin::GalleryImage.count') do
      post admin_gallery_images_url, params: { admin_gallery_image: { title: @admin_gallery_image.title } }
    end
  ...
  test "should update admin_gallery_image" do
    patch admin_gallery_image_url(@admin_gallery_image), params: { admin_gallery_image: { title: @admin_gallery_image.title } }
